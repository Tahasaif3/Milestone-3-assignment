...
export const GlowingCard = motion(forwardRef<HTMLDivElement, GlowingCardProps>( 
      ...
      <div className="relative">
        {typeof children === 'function' ? 
          ...
          children instanceof MotionValue ? (
            // Wrap MotionValue in a motion component
            <motion.div>{children}</motion.div>
          ) : (
            children // Render children directly if it's a ReactNode
          )
        }
      </div>
    </motion.div>
...
export const CardHeader = motion(forwardRef<HTMLDivElement, HTMLMotionProps<"div">>( 
  ({ className, ...props }, ref) => (
    <motion.div 
      ref={ref}
...
export const CardContent = motion(forwardRef<HTMLDivElement, HTMLMotionProps<"div">>( 
  ({ className, ...props }, ref) => (
    <motion.div 
      ref={ref}
...
export const CardFooter = motion(forwardRef<HTMLDivElement, HTMLMotionProps<"div">>( 
  ({ className, ...props }, ref) => (
    <motion.div 
      ref={ref}
...
export const CardTitle = motion(forwardRef<HTMLHeadingElement, HTMLMotionProps<"h3">>( 
  ({ className, ...props }, ref) => (
    <motion.h3
      ref={ref}
...
export const CardDescription = motion(forwardRef<HTMLParagraphElement, HTMLMotionProps<"p">>( 
  ({ className, ...props }, ref) => (
    <motion.p
      ref={ref}
